    ...
    <div class="flexslider">
          <ul class="slides">
            <li data-thumb="{{asset('/')}}/front/images/si.jpg">
                <div class="thumb-image"> <img src="{{asset('/')}}/front/images/si.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="{{asset('/')}}/front/images/si1.jpg">
                 <div class="thumb-image"> <img src="{{asset('/')}}/front/images/si1.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="{{asset('/')}}/front/images/si2.jpg">
               <div class="thumb-image"> <img src="{{asset('/')}}/front/images/si2.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
          </ul>
    </div>
</div>
<div class="col-md-7 single-top-in">
        ...
        <div class="content-top1">
            <div class="col-md-4 col-md4">
                <div class="col-md1 simpleCart_shelfItem">
                    <a href="single.html">
                        <img class="img-responsive" src="{{asset('/')}}/front/images/pi6.png" alt="" />
                    </a>
        ...
        <div class="col-md-4 col-md4">
                <div class="col-md1 simpleCart_shelfItem">
                    <a href="single.html">
                        <img class="img-responsive" src="{{asset('/')}}/front/images/pi7.png" alt="" />
                    </a>
        ...
        <div class="col-md-4 col-md4">
                <div class="col-md1 simpleCart_shelfItem">
                    <a href="single.html">
                        <img class="img-responsive" src="{{asset('/')}}/front/images/pi.png" alt="" />
                    </a>
